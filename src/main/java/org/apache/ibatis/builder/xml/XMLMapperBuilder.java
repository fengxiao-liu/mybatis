...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    public void parse() {
        ...
        //重新解析一次在 configurationElement(parser.evalNode("/mapper")); 解析时出现异常的配置
        //parsePendingResultMaps()：对应的是 解析xml文件中resultMap标签出现异常的配置解析
        //parsePendingChacheRefs()：对应的是 解析xml文件中cache-ref标签出现异常的配置解析
        //parsePendingStatements()：对应的是 解析xml文件中select|insert|update|delete标签出现异常的配置解析
